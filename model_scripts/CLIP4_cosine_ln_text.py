...
RESULTS_DIR = "/home/giadapoloni/results2/CLIP4_cosine_ln_with_text"
RESULTS_CSV_METRICS = os.path.join(RESULTS_DIR, "clip4_test_metrics_global_cosine_ln_with_text.csv")
RESULTS_CSV_METRICS_VIDEO = os.path.join(RESULTS_DIR, "clip4_test_metrics_video_cosine_ln_with_text.csv")
SAVE_PATH = os.path.join(RESULTS_DIR, "clip4_cosine_ln_with_text.pt")
