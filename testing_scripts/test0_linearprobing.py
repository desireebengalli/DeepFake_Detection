...
CKPT_PATH = "/home/liciabordignion/results_linearprobing/clip0_linear.pt"
...
RESULTS_DIR = "/home/liciabordignion/results_TEST_CLIP0_linearprobing"
RESULTS_CSV_FRAME = os.path.join(RESULTS_DIR, "clip0_test_metrics_global_linear_frame.csv")
RESULTS_CSV_VIDEO = os.path.join(RESULTS_DIR, "clip0_test_metrics_global_linear_video.csv")
